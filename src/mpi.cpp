...
void slave(){
    ...
    while (cont) {
        ...
        if (count % 2 == 1) {
            update(data_odd_local, data_even_local, my_begin_row_id, my_end_row_id);
            maintain_fire(data_even_local, fire_area, my_begin_row_id, my_end_row_id);
            maintain_wall(data_even_local, my_begin_row_id, my_end_row_id);
        } else {
            update(data_even_local, data_odd_local, my_begin_row_id, my_end_row_id);
            maintain_fire(data_odd_local, fire_area, my_begin_row_id, my_end_row_id);
